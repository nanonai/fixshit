...
public class ModifyUser {
    ...
    public static void UpdateUser(User user) {
        ModifyUser.current_user = user;
    }

    public static boolean[] ShowPage() {
        boolean[] result = new boolean[]{false, false};
        JDialog dialog = new JDialog(parent, "Modify User", true);
        ...
        JLabel title = new JLabel("Modify User");
        ...
        switch (current_user.getAccType()) {
            case "Finance Manager":
                types.setSelectedItem("Finance Manager");
                List<PurchaseOrder> po_record = User.checkPORecordByID(current_user.getUserID());
            ...
            case "Purchase Manager":
                ...
                List<Payment> py_record = User.checkPYRecordByID(current_user.getUserID());
                if (!py_record.isEmpty()) {
                    types.setEnabled(false);
                    types.setToolTipText("<html>This account has related activities/history.<br>" +
                            "You are not allowed to change its role!</html>");
                }
            ...
            case "Sales Manager":
                ...
                List<Sales> sales_record = User.checkSalesRecordByID(current_user.getUserID());
                List<PurchaseRequisition> pr_record = User.checkPRRecordByID(current_user.getUserID());
        ...
        username.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if (!Objects.equals(input, current_user.getUsername())) {
        ...
        fullname.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if (!input.equals(current_user.getFullName())) {
        ...
        email.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if (!input.equals(current_user.getEmail())) {
        ...
        phone.setText(current_user.getPhone().substring(1));
        ...
        phone.addFocusListener(new FocusListener() {
            ...
            public void focusLost(FocusEvent e) {
                ...
                if (!input.equals(current_user.getPhone().substring(1))) {
        ...
        confirm.addActionListener(_ -> {
            if (username.getText().isEmpty() || fullname.getText().isEmpty() || password.getText().isEmpty() ||
                ...
                String validity = new User().ValidityCheckerWithHistory(checking, current_user);
                if (validity.charAt(0) == '0') {
                    ...
                    User modified = new User(current_user.getUserID(), username.getText(), password.getText(), fullname.getText().trim(),
                            email.getText(), "0" + phone.getText(), acc_type, current_user.getDateOfRegis(), 0);
                    if (!Objects.equals(current_user.getAccType(), acc_type)) {
                        modified.setUserID(new User().IdMakerWithType(acc_type));
                        result[1] = true;
                    }
                    if (!Objects.equals(modified.getUsername(), current_user.getUsername()) ||
                            !Objects.equals(modified.getPassword(), current_user.getPassword()) ||
                            !Objects.equals(modified.getFullName(), current_user.getFullName()) ||
                            !Objects.equals(modified.getEmail(), current_user.getEmail()) ||
                            !Objects.equals(modified.getPhone(), current_user.getPhone()) ||
                            !Objects.equals(modified.getAccType(), current_user.getAccType())) {
                        boolean sure = CustomComponents.CustomOptionPane.showConfirmDialog(
                                parent,
                                "Confirm to modify user data and all related history?",
                                "Confirmation",
                                new Color(209, 88, 128),
                                new Color(255, 255, 255),
                                new Color(237, 136, 172),
                        ...
                        if (sure) {
                            new User().Modify(current_user.getUserID(), modified);
                            result[0] = true;
                            dialog.dispose();
                        }
                    } else {
