...
public class ItemDetails {
    ...
    public static boolean ShowPage() {
        ...
        gbc.weightx = 2;
        gbc.insets = new Insets(0, 0, 10, 10);
        JLabel userid = new JLabel("    " + current_item.getItemID());
        ...
        gbc.gridy = 2;
        JLabel type = new JLabel("    " + current_item.getItemName());
        type.setOpaque(true);
        ...
        gbc.gridy = 3;
        JLabel username = new JLabel("    " + current_item.getUnitPrice());
        ...
        gbc.gridy = 4;
        JLabel fullname = new JLabel("    " + current_item.getUnitCost());
        ...
        gbc.gridy = 5;
        JLabel email = new JLabel("    " + current_item.getStockCount());
        ...
        gbc.gridy = 6;
        JLabel email1 = new JLabel("    " + current_item.getThreshold());
        ...
        gbc.gridy = 7;
        JLabel date = new JLabel("    " + current_item.getCategory());
        date.setOpaque(true);
        ...
        gbc.gridy = 8;
        JLabel date1 = new JLabel("    " + current_item.getLastUpdate());
